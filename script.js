...
const contactButtons = document.querySelectorAll('.contact-item a, .btn-primary, .btn-secondary');
...
document.addEventListener('keydown', (e) => {
    ...
    if (lightbox.style.display === 'block') {
        ...
        } else if (e.key === 'ArrowRight' && currentMediaIndex < currentMediaList.length - 1) {
            currentMediaIndex++;
            loadMediaItem(currentMediaIndex);
        }
    }
...
const projectMedia = {
    'Unproject - VR Design Tool': [
        { src: 'assets/images/projects/Unproject.png', type: 'image', name: 'VR Design Tool Interface' },
        { src: 'assets/videos/Unproject.mp4', type: 'video', name: 'VR Design Demo' }
    ],
    'Oneroot Android Apps': [
        { src: 'assets/images/projects/Oneroot.png', type: 'image', name: 'Android Apps Screenshot' }
    ],
    'BlackBox Development': [
        { src: 'assets/images/projects/Blackbox.png', type: 'image', name: 'BlackBox Website' }
    ],
    'Woo Plugin Wizard': [
        { src: 'assets/images/projects/WooPlugin.png', type: 'image', name: 'Plugin Generator Interface' }
    ],
    'Drypto UI Animations': [
        { src: 'assets/videos/Drypto_animation.mp4', type: 'video', name: 'UI Animation Demo' }
    ],
    'Practice Range VR': [
        { src: 'assets/images/projects/PracticeRange.png', type: 'image', name: 'Practice Range Screenshot' },
        { src: 'assets/videos/VR_GunReload.mp4', type: 'video', name: 'Gun Reload Demo' },
        { src: 'assets/videos/VR_GunShoot.mp4', type: 'video', name: 'Gun Shooting Demo' }
    ],
    'Run Across': [
        { src: 'assets/images/projects/RunAcross.jpg', type: 'image', name: '3D Platformer Screenshot' }
    ],
    'Lost In The Woods': [
        { src: 'assets/videos/CarCrash.mp4', type: 'video', name: 'Gaze Detection Demo' }
    ]
};
...
let lightboxTitle, lightboxNavigation, lightboxPrevBtn, lightboxNextBtn, lightboxCounter, lightboxVideo, mediaTypeIndicator;

// Project Card Click Handlers
const projectLinks = {
    '#unproject-link': 'https://www.unproject.ai',
    '#oneroot-marketplace': 'https://play.google.com/store/apps/details?id=enp.oneroot.marketplace&hl=en_IN',
...
function openMediaViewer(projectTitle, startIndex = 0) {
    ...
    console.log('Opening media viewer for:', projectTitle, 'with', mediaList.length, 'items');
...
function loadMediaItem(index) {
    ...
    if (lightboxPrevBtn && lightboxNextBtn) {
        ...
        console.log('Navigation buttons updated. Prev disabled:', lightboxPrevBtn.disabled, 'Next disabled:', lightboxNextBtn.disabled);
    }
...
document.querySelectorAll('.project-card').forEach(card => {
    ...
    card.addEventListener('click', (e) => {
        ...
        if (e.target.closest('.project-image') || e.target.closest('.project-overlay')) {
            return;
        }
